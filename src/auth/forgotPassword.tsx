  ...
  const handleRequest: (
    ...
    axios
      ...
      .then((response) => {
        ...
        // notify("Successful, check your inbox and follow the prompt.");
      })
      .catch((error) => {
        setLoading(false);
        warn(
    ...
    <AuthContainer>
      ...
      {success ? (
        <div className="h-full flex justify-center items-center">
          <div className="flex flex-col justify-center items-center space-y-5">
            ...
            <p className="text-center">
              Your password reset link has been sent to you, <br /> please check your inbox
        ...
        <form onSubmit={handleRequest}>
          ...
          <p>Please provide your email address to get a password reset link.</p>
