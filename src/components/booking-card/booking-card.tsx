...
import { formatNumberWithDenomination } from "../../utils/_helper";

const cardData = [
    { name: "Bookings Count", icon: bookingCount },
      ...
      <div className="bg-primary relative text-white p-4 rounded-lg shadow-md">
        ...
        <div className="flex flex-col items-start">
          <div className="flex gap-3 items-center mb-4">
            ...
            <h2 className="font-bold text-4xl">{cardName === "Total Value"? formatNumberWithDenomination(value): value}</h2>
          </div>
          <div>
